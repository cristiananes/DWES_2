...
public class AstronautaController {
	...
	public ModelAndView getAstronauta(@PathVariable Long id) {
		...
		ModelAndView salida = new ModelAndView("astronauta");
	...
	public ModelAndView getTodosAstronautaspag(@PathVariable int pagina) {
		ModelAndView salida = new ModelAndView("astronautas");	
	...
	//la siguiente ruta tiene que eliminar un astronauta y devolverte a la lista de astronautas
